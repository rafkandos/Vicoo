...
<head>
  <title>On Progres Page | VICO</title>
  <meta charset="utf-8">
          ...
          <?php
            ...
            if ($c->Time == $date) {
                ...
                <td>'.$no++.'</td>
                    ...
                    <td>'.$c->Value.'</td>
                    <td align="center">
                      <a onclick="edit_comp('.$c->Id_Complaint.')" href="#" data-toggle="modal" data-target="#update_comp" class="btn btn-primary btn-sm">edit</a>
                    </td>
				</tr>
				';
              }								
  ...
  <div class="modal fade" id="update_comp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url()?>index.php/admin/edit_comp" method="post">
